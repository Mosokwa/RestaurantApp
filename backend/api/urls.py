...
from .views import (
    ...
    DietaryPicksView, RecentlyViewedView, TimeBasedRecommendationsView, RestaurantsYouMightLikeView, FastDeliveryRestaurantsView, PriceRangeFilterView, LocalFavoritesView, TrendingTodayView, ExploreOtherCitiesView, RestaurantStoriesView, AnonymousTrackUserBehaviorView, DiscoverSearchView, LoadMoreSectionView
)
...
urlpatterns = [
    ...
    path('search/load-more/', LoadMoreSectionView.as_view(), name='load-more'),
    # Enhanced Search endpoints(private)
    path('search/discover/', DiscoverSearchView.as_view(), name='discover_search'),
